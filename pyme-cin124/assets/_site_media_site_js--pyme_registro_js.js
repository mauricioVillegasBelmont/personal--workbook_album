  ...
  if (element.type == 'text') {
    switch (element.name) {
      ...
      case 'ticket':
        ...
        break;
      case 'confirmacion':
        element.setCustomValidity('Por favor, ingresa tu número de confirmación');
        break;
      case 'transaccion':
        element.setCustomValidity('Por favor, ingresa tu número de transacción');
        break;
      case 'cine_id':
        element.setCustomValidity('Por favor, ingresa tu número de Id del cine que viene en tu boleto');
        break;
      default:
...
$(document).ready(function () {
  ...
  $('[popovertarget]').on('click', function (e) {
    e.preventDefault();
    var _m = $(this).attr('popovertarget')
    $('#'+_m).toggle();
  })
