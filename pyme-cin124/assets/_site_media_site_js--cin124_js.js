...
Pymeweb.prototype.init_page_sizer = function(){
  $('html').css({
    "--header-h": function (i) {
      ...
      return (h != undefined) ? h + 'px' : 0;
    },
    "--footer-h": function(i){
      var h = $('#main-footer').outerHeight();
      return (h != undefined)? h + 'px':0;
    },
    "--body-h": function (i) {
...
Pymeweb.prototype.init_inputs = function(){
  $('input[type="text"],input[type="mail"],input[type="date"]').on( "focus", function(){
    $('body').addClass('input-mode');
  });
  $('input[type="text"],input[type="mail"],input[type="date"]').on( "blur", function(){
  ...
  $('input[type="file"]').on('input',function(){
    ...
    $('input[type="file"]').not(this).prop( {required: false} );
    $(id).text(fname)
  })

  //if( $('input[name="lote"]').length>0 ){
  //  $('input[name="lote"]').mask("Lote 000/000");
  //}
}
...
Pymeweb.prototype.init_page = function (t = 1000) {
  var self = this;
  setTimeout(function () {
    $('body').removeClass('preload');
  }, t);
}
Pymeweb.prototype.addJQ_functions = function () {}

const prom1006 = new Pymeweb();
$( document ).ready(function() {
  prom1006.init_ready(conf,triggers);
  prom1006.addJQ_functions();
});
$(window).on('load', function(){
  prom1006.init_load();
  prom1006.init_page(0);
});
